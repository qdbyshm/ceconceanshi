...
- (NSString *)encryptedWithAESUsingKey:(NSString *)key andIV:(NSData *)iv
{
    ...
    NSString *encryptedString = [encrypted base64_base64EncodedString];
...
{
    NSData *decrypted = [[NSData base64_dataWithBase64EncodedString:self] decryptedWithAESUsingKey:key andIV:iv];
...
{
    NSData *decrypted = [[NSData base64_dataWithBase64EncodedString:self] decryptedWith3DESUsingKey:key andIV:iv];
    NSString *decryptedString = [[NSString alloc] initWithData:decrypted encoding:NSUTF8StringEncoding];
